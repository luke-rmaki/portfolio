...
ES6 Arrow Functions, also known as Fat Arrows, are one of the simpler new features in ES6. They provide two benefits: more concise syntax, and lexical scoping of this. Let’s take a look at the syntax first.

### Arrow Function Syntax

Arrow functions provide a simpler and more concise way to define functions. Take the following callback function as an example:

![https://cdn-images-1.medium.com/max/2000/1*DBg85yAZexDLyxr6G1rAiQ.png](https://cdn-images-1.medium.com/max/2000/1*DBg85yAZexDLyxr6G1rAiQ.png)

That is a lot of code for a very simple task. Let’s rewrite this function, substituting the anonymous callback with an **arrow function**:

![https://cdn-images-1.medium.com/max/2000/1*x2rDZDudUCsc92RalaV70Q.png](https://cdn-images-1.medium.com/max/2000/1*x2rDZDudUCsc92RalaV70Q.png)

_Using an arrow function saved us one line of code._
