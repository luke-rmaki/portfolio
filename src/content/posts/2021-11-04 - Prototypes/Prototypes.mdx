...
What we've looked as so far is how we can utilize prototypes in creating our own objects as a collection for all the properties and methods we want our objects to inherit. But prototypes are built into the JavaScript lanaguage itself.
